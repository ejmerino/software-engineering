...
public class MainAppView extends JFrame {
    ...
    private void initComponents() {
        ...
        //tabbedPane.putClientProperty(FlatClientProperties.TABBED_PANE_BOLD_TABS, true);

        tabbedPane.addTab("Facturación y Clientes", createBillingTab());
        tabbedPane.addTab("Consultas", createConsultationTab());
    ...
    private JPanel createSalePanel() {
        ...
        //btnProcesarCompra.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_PRIMARY);
    ...
    private JPanel createSaleFormPanel() {
        ...
        //btnAgregarAlCarrito.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_PRIMARY);
